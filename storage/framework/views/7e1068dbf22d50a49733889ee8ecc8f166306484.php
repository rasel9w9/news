		...
		<?php echo csrf_field(); ?>
		  <fieldset>
				<div class="control-group">
				  ...
				  <div class='controls'><?php $__errorArgs = ['advertisement_name'];
...
unset($__errorArgs, $__bag); ?></div>
				...
				<div class="control-group">
				  ...
				  <div class='controls'><?php $__errorArgs = ['advertisement_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></div>
				...
				<div class="control-group hidden-phone">
				  ...
				  <div class='controls'><?php $__errorArgs = ['advertisement_status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
			  ...
			  <?php $__currentLoopData = $allAdvertisements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $advertisement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<tr>
					...
					<?php if(in_array('22',$rolls)): ?>
						<?php if($advertisement->advertisement_status==0): ?>
						<a class="btn btn-success" href="<?php echo e(route('catStatus',[$advertisement->advertisement_id,1])); ?>">
							<i class="halflings-icon white thumbs-up"></i>
						</a>
						<?php else: ?>
							<a class="btn btn-danger" href="<?php echo e(route('catStatus',[$advertisement->advertisement_id,0])); ?>">
