...
<!--icons-css-->
<link href="{{asset('public/backend/css/font-awesome.css')}}css/font-awesome.css" rel="stylesheet"> 
<!--Google Fonts-->
    ...
    <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        ...
		        <li><a href="#"><i class="fa fa-cogs"></i><span>Post</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul>
		            <li><a href="{{route('addpost')}}">Add Post</a></li>
		            <li><a href="portlet.html">All Post</a></li>		            
		          </ul>
		        </li>
